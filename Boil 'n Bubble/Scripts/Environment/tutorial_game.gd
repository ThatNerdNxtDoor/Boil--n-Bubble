...
var tutorial_text_track = ["Welcome to [color=purple]Boil n' Bubble[/color]! This tutorial serves to help you understand some basic aspects of the game before you go off into the wilderness!",
							...
							"Once you've put in your ingredients, you can [b]interact[/b] with the nozzle attached to the [color=purple]cauldron[/color]. Just be sure to not put too much in... If you see [color=dark gray]bubbles[/color], you'll want to back away.",
